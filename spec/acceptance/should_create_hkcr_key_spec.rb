...
describe 'Registry Key Management - HKCR' do
  ...
  context 'registry test key variable setup' do
    ...
    keypath = "HKCR\\Software\\Vendor\\#{keyname}"
...
PHASE3
    ...
    keys_created_native = [
        /Registry_key\[HKCR.Software.Vendor.PuppetLabsTest\w+\].ensure: created/,
        /Registry_key\[HKCR.Software.Vendor.PuppetLabsTest\w+\\SubKey1\].ensure: created/
    ]

    keys_created_wow = [
        /Registry_key\[32:HKCR.Software.Vendor.PuppetLabsTest\w+\].ensure: created/,
        /Registry_key\[32:HKCR.Software.Vendor.PuppetLabsTest\w+\\SubKey1\].ensure: created/
    ]

    # A set of regular expression of values to be purged in phase 2.
    values_purged_native = [
        /Registry_value\[hkcr.Software.Vendor.PuppetLabsTest\w+.SubKeyToPurge.Value1\].ensure: removed/,
        /Registry_value\[hkcr.Software.Vendor.PuppetLabsTest\w+.SubKeyToPurge.Value2\].ensure: removed/,
        /Registry_value\[hkcr.Software.Vendor.PuppetLabsTest\w+.SubKeyToPurge.Value3\].ensure: removed/
    ]

    values_purged_wow = [
        /Registry_value\[32:hkcr.Software.Vendor.PuppetLabsTest\w+.SubKeyToPurge.Value1\].ensure: removed/,
        /Registry_value\[32:hkcr.Software.Vendor.PuppetLabsTest\w+.SubKeyToPurge.Value2\].ensure: removed/,
        /Registry_value\[32:hkcr.Software.Vendor.PuppetLabsTest\w+.SubKeyToPurge.Value3\].ensure: removed/
    ]
